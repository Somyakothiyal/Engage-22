...
def identify_face():
    ...
    Out_fold = r'D:\Project\Facial-Similarity-with-Siamese-Networks-in-Pytorch-master\output_fold'
    ...
    image = cv2.imread(r"D:\Project\Facial-Similarity-with-Siamese-Networks-in-Pytorch-master\input_fold\SatyaNadella.jpg")
