...
app.config['UPLOAD_FOLDER'] = r'D:\Project\Facial-Similarity-with-Siamese-Networks-in-Pytorch-master\input_fold'
app.config['OUTPUT_FOLDER'] = r'D:\Project\Facial-Similarity-with-Siamese-Networks-in-Pytorch-master\output_fold'
...
def upload_file():
   if request.method == 'POST':
      ...
      f.save(os.path.join(app.config['UPLOAD_FOLDER'], 'SatyaNadella.jpg'))
